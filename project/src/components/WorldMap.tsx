...
const locations: Location[] = [
  ...
  },
  {
    ...
    url: "https://fr.wikipedia.org/wiki/%C3%89gypte"
  },
  {
    name: "Nigéria",
    ...
    url: "https://fr.wikipedia.org/wiki/Nig%C3%A9ria"
  },
  {
    name: "Japon",
  ...
  {
    name: "Japon 2",
    position: latLonToXYZ(35.6895, 139.7670),
        ...
        {locations.map((location, index) => (
          <group key={index} position={location.position}>
            ...
            >
              ...
              {/* Matériau du point */}
              <meshBasicMaterial 
                color={hovered === location.name ? "#ffff00" : "#ff69b4"}
                transparent
